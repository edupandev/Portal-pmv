        ...
        const updated = {
          ...
          [id]: {
            ...
            red: {
              ...
              fundo: sync.r_fnd !== undefined ? rgb565ToHex(sync.r_fnd) : existing.red.fundo || '#000000',
            ...
            green: {
              ...
              fundo: sync.g_fnd !== undefined ? rgb565ToHex(sync.g_fnd) : existing.green.fundo || '#000000',
